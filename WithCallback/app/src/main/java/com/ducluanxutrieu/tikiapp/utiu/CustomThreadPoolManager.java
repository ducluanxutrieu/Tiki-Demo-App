...
public class CustomThreadPoolManager {
    ...
    public void cancelAllTasks() {
        ...
        Log.i("HomeViewModel", Calendar.getInstance().getTime().getTime() + "All tasks in the thread pool are cancelled");
    ...
    private static class BackgroundThreadFactory implements ThreadFactory {
        ...
        public Thread newThread(Runnable runnable) {
            ...
            thread.setUncaughtExceptionHandler((thread1, ex) -> Log.e(Util.LOG_TAG, thread1.getName() + " encountered an error: " + ex.getMessage()));
            return thread;
        }
    }
}
